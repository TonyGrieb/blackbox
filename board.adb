   ...
   begin --setup_board    
      ...
      for Index in 1..gameboard.length loop
         for Index2 in 'A'..character'val(gameboard.length+64) loop
            x:= 5+(height*(character'pos(Index2)-65))-character'pos(Index2)+64;
            y:= 9+(width*(Index-1))-Index;
	...
	begin --update_board
	 ...
	 when left => screen.movecursor((1,gamboard.carrotposition.index*(20/gameboard.length)));ada.text_io.put('>'); 
	 ...
	 when left => screen.movecursor((2,gamboard.lposition.inposition.index*(20/gameboard.length)));ada.text_io.put('-'); 
	 ...
	 when left => screen.movecursor((2,gamboard.lposition.outposition.index*(20/gameboard.length)));ada.text_io.put('-'); 
